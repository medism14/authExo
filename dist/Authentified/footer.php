...
document.addEventListener('DOMContentLoaded', function () {
  $(document).ready(function() {
    ...
    const categories = /http:\/\/127.0.0.1\/PHP\/authExo\/dist\/Authentified\/categories.*/;
    const produits = /http:\/\/127.0.0.1\/PHP\/authExo\/dist\/Authentified\/products.*/;
    const index = /http:\/\/127.0.0.1\/PHP\/authExo\/dist\/Authentified*/;
